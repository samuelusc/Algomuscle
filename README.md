...
| 1       | [Two Sum](https://leetcode.com/problems/two-sum/description/) | [Dictionary - Hash Table](./0001-two-sum/0001-two-sum.py)  | Easy       |  Hash Table, Array      | Hash Table: T: O(n), S: O(n) |       |
