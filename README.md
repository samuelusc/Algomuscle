...
| Question# | Title                                           | Solution                                                                                               | Difficulty | Topics | Complexity                                | Nodes |
|-----------|-------------------------------------------------|--------------------------------------------------------------------------------------------------------|------------|--------|-------------------------------------------|-------|
| 242       | [Valid Anagram](https://leetcode.com/problems/valid-anagram/description/) | [Counter-Space Save](https://github.com/samuelusc/Algomuscle/blob/main/0242-valid-anagram/spCounter-0242-valid-anagram.py), [Counter-easy coding](https://github.com/samuelusc/Algomuscle/blob/main/0242-valid-anagram/easyCounter-0242-valid-anagram.py) | Easy       |  Hash Table, String      | Space Save: T:O(n),S:O(1), Easy Coding: T:O(n),S:O(n)   |       |
| 349        | [Intersection of Two Array](https://leetcode.com/problems/intersection-of-two-arrays/description/) | [Set- Hash Table](https://github.com/samuelusc/Algomuscle/blob/main/0349-intersection-of-two-arrays/set-0349-intersection-of-two-arrays.py), [dictionary-Hash Table](https://github.com/samuelusc/Algomuscle/blob/main/0349-intersection-of-two-arrays/dict-0349-intersection-of-two-arrays.py) | Easy     | Hash Table, Array       |   set: T:O(n+m), S:(n+m), dictionary: T:O(n+m), S: O(n)                                      |       |
| 202       | [Happy Number](https://leetcode.com/problems/happy-number/description/) | [Set - Hash Table](https://github.com/samuelusc/Algomuscle/blob/main/0202-happy-number/set-0202-happy-number.py), [Hashtable - Python](https://github.com/samuelusc/Algomuscle/blob/main/0160-intersection-of-two-linked-lists/hashTable-0160-intersection-of-two-linked-lists.py) | Easy       |  Hash Table, Two Pointer    | Set: T: O(d) where d is the numberof digits in n, S:O(k) where k is the number of unique digits in set(), Two Pointer: S: O(logn) where n is the size of the input value, T: O(1) |       |
| 1       | [Two Sum](https://leetcode.com/problems/two-sum/description/) | [Dictionary - Hash Table](https://github.com/samuelusc/Algomuscle/blob/main/0001-two-sum/0001-two-sum.py)  | Easy       |  Hash Table, Array      | Hash Table: T: O(n), S: O(n) |       |
| 34       | [Two Sum](https://leetcode.com/problems/two-sum/description/) | [bisect - Binary Search](https://github.com/samuelusc/Algomuscle/blob/main/0034-find-first-and-last-position-of-element-in-sorted-array/bisect-0034-find-first-and-last-position-of-element-in-sorted-array.py), [regular - Binary Search](https://github.com/samuelusc/Algomuscle/blob/main/0034-find-first-and-last-position-of-element-in-sorted-array/binarySearch-0034-find-first-and-last-position-of-element-in-sorted-array.py)   | Medium       |  Hash Table, Array      | bisect: T: O(logn), S: O(1), Regular binary Search: O(n) where n is the number of elements in the array, S: O(1)|      |
