...
| 15      | [3Sum](https://leetcode.com/problems/3sum/) | 1. [Two Pointer](./0015-3sum/twoPointers-0015-3sum.py)| Medium      |  Array, Tow Pointers, Sorting   | T: O(n^2), S: O(n^2) |       |
| 18       | [4Sum](https://leetcode.com/problems/4sum/description/) | 1. [Two Pointer](./0001-two-sum/0001-two-sum.py)  | Medium       |  Hash Table, Array, Sorting      | T: O(n^3), S: O(m) where m is the number of unique quadruplets that sums up to the target |       |
